...
from pages.liked_surveys import LikedSurveysWindow
...
class ProfilePage(ctk.CTkFrame):
    def __init__(self, parent, app):
        ...
        self.header = ctk.CTkFrame(self, fg_color=Colors.SECONDARY_BG, corner_radius=16)
        ...
        self.details = ctk.CTkFrame(self, fg_color=Colors.BACKGROUND)
    ...
    def _open_liked_surveys(self):
        LikedSurveysWindow(self, self.app)
